// Configuration for Ptolemy's Geography Globe - Simplified version
// Ptolemy: 180,000 stades circumference (0.714x Eratosthenes' 252,000)
export const config = {
  // Globe title and description
  title: "Ptolemy's Geography - Interactive Globe",
  ...
  // GeoJSON point data (settlements)
  geoJsonPointFiles: [
    {
      path: './poleis_episemoi.geojson',
      color: 'purple',
      radius: 0.3,
      altitude: 0.004
    }
  ...
  mapOverlays: [
    { radius: 100.25, phistart: 2.61, philength: 2, northLat: 90, southLat: -63,
      texture: "./assets/textures/planets/white-square.png" },
    { radius: 100.25, phistart: 2.61, philength: 2, northLat: -63, southLat: 90,
      texture: "./assets/textures/planets/white-square.png" },
    { radius: 100.2, phistart: 0, philength: 1, northLat: 63, southLat: 16.45,
      texture: "./assets/textures/planets/ptolemy-hours2-blue.jpg" },
    { radius: 100.25, phistart: 0, philength: 1, northLat: -16.45, southLat: 63,
      texture: "./assets/textures/planets/brown_rect.jpg" }
  ]
};
